...
Semantic HTML is what gives the structure, as it is the blueprint of a page, meaning.

2. What are the 4 areas of the box model?

Margin, content, border, and padding
...
It is valuable for developers because it allows them to seemlessly work on a single project while housing multiple saving points without having to save each and every time. It also allows a team of individuals to work on the project simultaneously.

5. Define mobile-first design in your own words.

Starting with designing on a mobile device aspect ratio then scaling up from there to provide an evenly satisfying design across various screen sizes.
